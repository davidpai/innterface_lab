...
$(document).ready(function(){
    ...
    var init_version = function(){
        $('#version').val('');
        active_user_screenshot.version = '';
    };
    init_version();
    ...
    var init_comment = function(){
        $('#comment').val('');
        active_user_screenshot.comment = '';
    };
    init_comment();
    ...
    var click_screenshot = function($this) {
        ...
        console.log(active_user_screenshot.app);
        // 填入app資訊
        ...
        // 填入version
        if ( active_user_screenshot.version ) {
    ...
    <div id="wrapRight">
        <table width="336" border="0" align="left" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td width="144" align="center"><a href="javascript:history.go(-1);" class="style8 cancel" style="color: #FFF;" id="cancel">Cancel</a></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td height="32" background="images/line_vertital_dark.png">&nbsp;</td>
